...
export default class tabla extends Component {
  ...
  async getEnvios() {
    const row = axios.get("https://backnodes.up.railway.app/env/allEnvs");
  ...
  onSubmit = async (e) => {
    ...
    await axios.post("https://backnodes.up.railway.app/env/newEnv", newEnvio);
  ...
  EditEnv = async (id) => {
    const res = await axios.get("https://backnodes.up.railway.app/env/envByid/" + id);
    let row = res.data;
  ...
  onSubmitEdit = async (e) => {
    ...
    await axios.put(
      "https://backnodes.up.railway.app/env/update/" + this.state._id,
      editEnvio
    );
    this.getEnvios();
  };
  ...
  deleteOrder = async (id) => {
    await axios.delete("https://backnodes.up.railway.app/env/delete/" + id);
    this.getEnvios();
  };
  //!------------------------------------------------------------------------\\\
  render() {
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="row justify-content-center">
                  <div className="col-6">
                    <p>
                      <h5>Fecha:</h5> {this.state.fecha}
                    </p>
                  </div>
                  <div className="col-6">
                    <p>
                      <h5>Alto:</h5> {this.state.alto}cm
                    </p>
                  </div>
                </div>
                <div className="row justify-content-center">
                  <div className="col-6">
                    <p>
                      <h5>Ancho:</h5> {this.state.ancho}cm
                    </p>
                  </div>
                  <div className="col-6">
                    <p>
                      <h5>Largo:</h5> {this.state.largo}cm
                    </p>
                  </div>
                </div>
                <div className="row justify-content-center">
                  <div className="col-6">
                    <p>
                      <h5>Peso:</h5> {this.state.peso}Kg
                    </p>
                  </div>
                  <div className="col-6">
                    <p>
                      <h5>Direccion de Recogida:</h5> {this.state.direccionR}
                    </p>
                  </div>
                </div>
                <div className="row justify-content-center">
                  <div className="col-6">
                    <p>
                      <h5>Ciudad de Recogida:</h5> {this.state.ciudadR}
                    </p>
                  </div>
                  <div className="col-6">
                    <p>
                      <h5>Nombre del destinatario:</h5>{" "}
                      {this.state.nombredestinatario}
                    </p>
                  </div>
                </div>
                <div className="row justify-content-center">
                  <div className="col-6">
                    <p>
                      <h5>Cedula:</h5> {this.state.cedula}
                    </p>
                  </div>
                  <div className="col-6">
                    <p>
                      <h5>Ciudad de entrega:</h5> {this.state.ciudadE}
                    </p>
                  </div>
                </div>
                <p>
                  <h5>Direccion de entrega:</h5> {this.state.direccionE}
                </p>
              </div>
